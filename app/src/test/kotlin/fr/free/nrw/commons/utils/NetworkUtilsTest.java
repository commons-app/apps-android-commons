...
public class NetworkUtilsTest {
  ...
  public void testInternetConnectionEstablished() {
    ...
    boolean internetConnectionEstablished =
        NetworkUtils.isInternetConnectionEstablished(mockContext);
  ...
  public void testCellular2GNetwork() {
    ...
    when(mockTelephonyManager.getNetworkType()).thenReturn(NETWORK_TYPE_EDGE);
  ...
  public void testCellular3GNetwork() {
    ...
    TelephonyManager mockTelephonyManager = mock(TelephonyManager.class);
    when(mockTelephonyManager.getNetworkType()).thenReturn(NETWORK_TYPE_HSPA);
  ...
  public void testCellular4GNetwork() {
    ...
    TelephonyManager mockTelephonyManager = mock(TelephonyManager.class);
    when(mockTelephonyManager.getNetworkType()).thenReturn(NETWORK_TYPE_LTE);
