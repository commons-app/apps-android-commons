...
public class UploadRepository {
  ...
  public UploadRepository(
      UploadLocalDataSource localDataSource, UploadRemoteDataSource remoteDataSource) {
  ...
  public Observable<UploadItem> preProcessImage(
    ...
    return remoteDataSource.preProcessImage(uploadableFile, place, source, similarImageInterface);
  }
