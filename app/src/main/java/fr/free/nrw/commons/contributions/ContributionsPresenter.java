...
public class ContributionsPresenter extends DataSetObserver implements UserActionListener {
  ...
  public Loader<Cursor> onCreateLoader(int id, @Nullable Bundle args) {
    ...
    return new CursorLoader(
        ...
        "",
        null,
        ContributionDao.CONTRIBUTION_SORT
            + "LIMIT "
  ...
  public int getChildPositionWithId(String id) {
    ...
    while (null != cursor && cursor.moveToNext()) {
      if (getContributionsFromCursor(cursor).getContentUri().getLastPathSegment().equals(id)) {
  ...
  public void onInvalidated() {
    super.onInvalidated();
    // Not letting the view know of this as of now, TODO discuss how to handle this and maybe show a
    // proper ui for this
  }
