...
public interface CategoryInterface {
  ...
  Observable<MwQueryResponse> searchCategories(
      @Query("gsrsearch") String filter,
  ...
  Observable<MwQueryResponse> searchCategoriesForPrefix(
      @Query("gacprefix") String prefix,
