...
public interface MediaInterface {
  ...
  @GET("w/api.php?action=query&format=json&formatversion=2" + //Basic parameters
      ...
      //Category parameters
      MEDIA_PARAMS)
  Observable<MwQueryResponse> getMediaListFromCategory(@Query("gcmtitle") String category,
  ...
  @GET("w/api.php?action=query&format=json&formatversion=2" + //Basic parameters
      ...
      MEDIA_PARAMS)
  Observable<MwQueryResponse> getMediaListFromSearch(@Query("gsrsearch") String keyword,
      @Query("gsrlimit") int itemLimit, @QueryMap Map<String, String> continuation);
