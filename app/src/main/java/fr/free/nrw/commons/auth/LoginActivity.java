...
public class LoginActivity extends AccountAuthenticatorActivity {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    ApplicationlessInjection.getInstance(this.getApplicationContext())
  ...
  protected void onResume() {
    ...
    if (sessionManager.getCurrentAccount() != null && sessionManager.isUserLoggedIn()) {
  ...
  protected void onDestroy() {
    ...
    try {
      // To prevent leaked window when finish() is called, see
  ...
  public void startMainActivity() {
    NavigationBaseActivity.startActivityWithFlags(
        this, MainActivity.class, Intent.FLAG_ACTIVITY_SINGLE_TOP);
    finish();
  }
    ...
    public void afterTextChanged(Editable editable) {
      boolean enabled =
          usernameEdit.getText().length() != 0
              ...
              && (BuildConfig.DEBUG
                  || twoFactorEdit.getText().length() != 0
                  || twoFactorEdit.getVisibility() != VISIBLE);
