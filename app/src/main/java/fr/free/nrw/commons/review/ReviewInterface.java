...
public interface ReviewInterface {
    @GET("w/api.php?action=query&format=json&list=recentchanges&continue=-||&formatversion=2&rcnamespace=6&rcprop=title|ids&rctype=new|log&rctoponly=1&rctag=android%20app%20edit")
