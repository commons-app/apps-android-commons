...
public class DepictionsImageListFragment extends DaggerFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_depict_images, container, false);
    ...
    private void initViews() {
        String depictName = getArguments().getString("depictName");
        if (getArguments() != null && depictName != null) {
    ...
    private void initList() {
        ...
        compositeDisposable.add(mediaClient.getMediaListFromCategory(depictName)
    ...
    private void setAdapter(List<Media> mediaList) {
        gridAdapter = new fr.free.nrw.commons.depictions.GridViewAdapter(this.getContext(), R.layout.layout_depict_image, mediaList);
    ...
    private void handleSuccess(List<Media> collection) {
        ...
        if (gridAdapter == null) {
            ...
            try {
                ((DepictionsDetailActivity) getContext()).viewPagerNotifyDataSetChanged();
            }catch (Exception e){
                e.printStackTrace();
            }
            try {
