  ...
  public void getCampaigns() {
    if (view != null && okHttpJsonApiClient != null) {
      ...
      campaigns
          ...
          .subscribeWith(
              new SingleObserver<CampaignResponseDTO>() {
                ...
                public void onSuccess(CampaignResponseDTO campaignResponseDTO) {
                  ...
                  Collections.sort(
                      ...
                      (campaign, t1) -> {
                        ...
                        try {
                          ...
                          date2 =
                              CommonsDateUtil.getIso8601DateFormatShort().parse(t1.getStartDate());
                  ...
                  try {
                    for (Campaign aCampaign : campaigns) {
                      campaignEndDate =
                          CommonsDateUtil.getIso8601DateFormatShort().parse(aCampaign.getEndDate());
                      campaignStartDate =
                          CommonsDateUtil.getIso8601DateFormatShort()
