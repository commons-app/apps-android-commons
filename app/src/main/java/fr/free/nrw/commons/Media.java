...
public class Media implements Parcelable {
   ...
   * just like categories. However unlike categories depictions is multi-lingual
   */
  ...
  /**
   * Creating Media object from MWQueryPage. Earlier only basic details were set for the media
   * object but going forward, a full media object(with categories, descriptions, coordinates etc)
  ...
  public String getDisplayTitle() {
    return filename != null ? getPageTitle().getDisplayTextWithoutNamespace()
        .replaceFirst("[.][^.]+$", "") : "";
  }
  ...
  /**
   * @return title to be shown on image thumbnail If caption is available for the image then it
   * returns caption else filename
   */
  ...
  /**
   * Gets the upload date of the file. Can be null.
   *
   ...
   * </p>
   * Does not append: i.e. will clear the current categories and then add the specified ones.
   *
  ...
  /**
   * Creates a way to transfer information between two or more activities.
   *
