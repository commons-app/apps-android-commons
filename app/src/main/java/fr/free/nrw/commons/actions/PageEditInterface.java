 ...
 *
 * <p>This interface posts a form encoded request to the wikimedia API with editing action as
 * argument to edit a particular page
 */
public interface PageEditInterface {
  ...
  @POST(MW_API_PREFIX + "action=edit")
  @NonNull
  Observable<Edit> postAppendEdit(
      @NonNull @Field("title") String title,
      @NonNull @Field("summary") String summary,
  ...
  @POST(MW_API_PREFIX + "action=edit")
  @NonNull
  Observable<Edit> postPrependEdit(
      @NonNull @Field("title") String title,
      @NonNull @Field("summary") String summary,
