...
/**
 * The Local Data Source for UploadRepository, fetches and returns data from local db/shared
 * prefernces
 */
@Singleton
public class UploadLocalDataSource {
  ...
  public UploadLocalDataSource(
      @Named("default_preferences") JsonKvStore defaultKVStore, UploadModel uploadModel) {
