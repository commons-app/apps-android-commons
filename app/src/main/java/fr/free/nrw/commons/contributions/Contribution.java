...
public class Contribution extends Media {
  ...
  public static Creator<Contribution> CREATOR =
      new Creator<Contribution>() {
        @Override
  ...
  public Contribution(
      ...
      String license) {
    super(
        localUri, imageUrl, filename, description, dataLength, dateCreated, dateUploaded, creator);
  ...
  public String getPageContents(Context applicationContext) {
    ...
    buffer
        ...
        .append(licenseTemplateFor(getLicense()))
        .append("\n\n")
        .append("{{Uploaded from Mobile|platform=Android|version=")
        .append(ConfigUtils.getVersionNameWithSha(applicationContext))
        .append("}}\n");
    ...
    if (dateCreated != null) {
      ...
      if (UploadableFile.DateTimeWithSource.EXIF_SOURCE.equals(dateCreatedSource)) {
        return String.format(
                Locale.ENGLISH, TEMPLATE_DATE_ACC_TO_EXIF, dateFormat.format(dateCreated))
            + "\n";
      } else {
        return String.format(
                Locale.ENGLISH, TEMPLATE_DATA_OTHER_SOURCE, dateFormat.format(dateCreated))
            + "\n";
      }
    }
    return "";
