...
public class MediaDetailFragment extends CommonsDaggerSupportFragment {
   ...
   * just like categories. However unlike categories depictions is multi-lingual Ex: key: en value:
   * monument
   */
  ...
  private void displayMediaDetails() {
    ...
    Disposable disposable = mediaDataExtractor
        .fetchMediaDetails(media.getFilename(), media.getPageId())
