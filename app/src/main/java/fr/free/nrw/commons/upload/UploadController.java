...
public class UploadController {
  ...
  private void startUpload(
      final Contribution contribution, final ContributionUploadProgress onComplete) {
  ...
  private void onUploadCompleted(Contribution contribution, ContributionUploadProgress onComplete) {
    // Starts the upload. If commented out, user can proceed to next Fragment but upload doesn't
    // happen
