...
import fr.free.nrw.commons.category.CategoryEditInterface;
...
public class NetworkingModule {
    ...
    @Provides
    @Singleton
    public CategoryEditInterface provideCategoryEditInterface(@Named(NAMED_COMMONS_WIKI_SITE) WikiSite commonsWikiSite) {
        return ServiceFactory.get(commonsWikiSite, BuildConfig.COMMONS_URL, CategoryEditInterface.class);
    }
