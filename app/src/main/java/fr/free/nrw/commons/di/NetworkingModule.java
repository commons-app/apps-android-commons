...
public class NetworkingModule {
  ...
  private static final String TEST_TOOLS_FORGE_URL =
  ...
  @Provides
  @Singleton
  public OkHttpJsonApiClient provideOkHttpJsonApiClient(
      OkHttpClient okHttpClient,
      @Named("tools_forge") HttpUrl toolsForgeUrl,
      @Named("default_preferences") JsonKvStore defaultKvStore,
      Gson gson) {
    return new OkHttpJsonApiClient(
        okHttpClient,
        toolsForgeUrl,
  ...
  /**
   * Gson objects are very heavy. The app should ideally be using just one instance of it instead of
  ...
  public Service provideWikidataService(
