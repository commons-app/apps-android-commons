...
public class RecentSearchesContentProvider extends CommonsDaggerContentProvider {
  ...
  public static final Uri BASE_URI =
      Uri.parse("content://" + BuildConfig.RECENT_SEARCH_AUTHORITY + "/" + BASE_PATH);
  ...
  public int delete(@NonNull Uri uri, String s, String[] strings) {
    ...
    switch (uriType) {
      case RECENT_SEARCHES_ID:
        ...
        rows =
            db.delete(
                RecentSearchesDao.Table.TABLE_NAME,
                "_id = ?",
                new String[] {uri.getLastPathSegment()});
        break;
      default:
  ...
  @Override
  public int update(
      @NonNull Uri uri, ContentValues contentValues, String selection, String[] selectionArgs) {
    /*
    ...
    switch (uriType) {
      case RECENT_SEARCHES_ID:
        if (TextUtils.isEmpty(selection)) {
          ...
          rowsUpdated =
              sqlDB.update(
                  TABLE_NAME, contentValues, COLUMN_ID + " = ?", new String[] {String.valueOf(id)});
        } else {
