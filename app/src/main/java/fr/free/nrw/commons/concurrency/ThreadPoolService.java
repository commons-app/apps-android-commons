...
public class ThreadPoolService implements Executor {
  ...
  private ThreadPoolService(final Builder b) {
    backgroundPool =
        new ExceptionAwareThreadPoolExecutor(
            b.poolSize,
            new ThreadFactory() {
              int count = 0;
              ...
              public Thread newThread(@NonNull Runnable r) {
                ...
                // Thread.MIN_PRIORITY
                // It's done prevent IllegalArgumentException and to prevent setting of improper
                // high priority for a less priority task
                t.setPriority(
  ...
  public ScheduledFuture<?> scheduleAtFixedRate(
      final Runnable task, long initialDelay, long period, final TimeUnit timeUnit) {
  ...
  public static class Builder {
     ...
     *     java.lang.Thread} or specify your own priority in the range 1(MIN_PRIORITY) to
     *     10(MAX_PRIORITY) By default, the priority is set to {@link java.lang.Thread#MIN_PRIORITY}
     */
