...
public class PlaceRenderer extends Renderer<Place> {
  ...
  public PlaceRenderer(
      Fragment fragment, ContributionController controller, OnBookmarkClick onBookmarkClick) {
          ...
          if (buttonLayout.isShown()) {
            ...
            if (recyclerView.getChildLayoutPosition(view) == lastPosition) {
              ((LinearLayoutManager) recyclerView.getLayoutManager())
                  .scrollToPositionWithOffset(lastPosition, buttonLayout.getHeight());
            }
          }
    ...
    cameraButton.setOnClickListener(
        view2 -> {
          if (applicationKvStore.getBoolean("login_skipped", false)) {
            ...
            Timber.d(
                "Camera button tapped. Image title: "
                    + place.getName()
                    + "Image desc: "
    ...
    galleryButton.setOnClickListener(
        view3 -> {
          if (applicationKvStore.getBoolean("login_skipped", false)) {
            ...
            Timber.d(
                "Gallery button tapped. Image title: "
                    + place.getName()
                    + "Image desc: "
                    + place.getLongDescription());
            storeSharedPrefs();
  ...
  public void render() {
    ...
    directionsButton.setOnClickListener(
        view -> Utils.handleGeoCoordinates(getContext(), this.place.getLocation()));
  ...
  private void popupMenuListener() {
    ...
    MenuItem wikipediaArticle =
        popupMenu.getMenu().findItem(R.id.nearby_info_menu_wikipedia_article);
