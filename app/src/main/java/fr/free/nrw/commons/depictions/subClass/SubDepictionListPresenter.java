...
public class SubDepictionListPresenter implements SubDepictionListContract.UserActionListener {
  ...
  /**
   * This creates a dynamic proxy instance of the class, proxy is to control access to the target
   * object here our target object is the view. Thus we when onDettach method of fragment is called
   * we replace the binding of view to our object with the proxy instance
   */
  ...
  public SubDepictionListPresenter(RecentSearchesDao recentSearchesDao, DepictsClient depictsClient,
      OkHttpJsonApiClient okHttpJsonApiClient, @Named(IO_THREAD) Scheduler ioScheduler,
