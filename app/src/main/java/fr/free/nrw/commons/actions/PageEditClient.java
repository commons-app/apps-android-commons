...
/**
 * This class acts as a Client to facilitate wiki page editing services to various dependency
 * providing modules such as the Network module, the Review Controller ,etc
 *
 * <p>The methods provided by this class will post to the Media wiki api documented at:
 * https://commons.wikimedia.org/w/api.php?action=help&modules=edit
 */
public class PageEditClient {
  ...
  public PageEditClient(
      CsrfTokenClient csrfTokenClient, PageEditInterface pageEditInterface, Service service) {
