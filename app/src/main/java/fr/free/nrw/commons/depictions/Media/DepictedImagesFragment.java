...
public class DepictedImagesFragment extends DaggerFragment implements DepictedImagesContract.View {
   ...
   * scrolls down Checks if the item has more images before loading Also checks whether images are
   * currently being fetched before triggering another request
   */
  ...
  public void setAdapter(List<Media> mediaList) {
    gridAdapter = new fr.free.nrw.commons.depictions.GridViewAdapter(getContext(),
        R.layout.layout_depict_image, mediaList);
