...
public class WikidataEditService {
  ...
  public void createImageClaim(@Nullable final WikidataPlace wikidataPlace,
      final UploadResult imageUpload) {
  ...
  @SuppressLint("CheckResult")
  private void editWikidataImageProperty(final WikidataItem wikidataItem,
      final UploadResult imageUpload) {
    wikidataClient
        .createImageClaim(wikidataItem, String.format("\"%s\"", imageUpload.getFilename()))
        .flatMap(revisionId -> {
          if (revisionId != -1) {
