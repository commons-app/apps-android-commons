...
public class UploadCategoriesFragment extends UploadBaseFragment
    implements CategoriesContract.View, CategoryClickedListener {
  ...
  @Inject CategoriesContract.UserActionListener presenter;
  ...
  private void initRecyclerView() {
    adapter = new UploadCategoriesAdapterFactory(this).create(new ArrayList<>());
