...
public class PhotographedNearbyPlaces{
    ...
    public PhotographedNearbyPlaces() {
        try {
            String query = FileUtils.readFromResource("/assets/queries/explore_nearby_query.rq");
            wikidataQuery = query;
    ...
    private List<Place> getFromWikidataQuery(LatLng cur,
        ...
        while ((line = in.readLine()) != null) {
            ...
            String imageLink = Utils.stripLocalizedString(fields[9]);
            ...
            places.add(new Place(
                    ...
                    new Sitelinks.Builder()
                            ...
                            .setImageLink(imageLink)    //imageLink is added
                            .build()
            ));
        }
        in.close();
