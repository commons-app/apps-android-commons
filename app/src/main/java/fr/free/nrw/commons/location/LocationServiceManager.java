...
public class LocationServiceManager implements LocationListener {
  ...
  // private Location lastLocationDuplicate; // Will be used for nearby card view on contributions
  // activity
  ...
  public enum LocationChangeType {
    ...
    LOCATION_MEDIUM_CHANGED, // Between slight and significant changes, will be used for nearby card
    // view updates.
