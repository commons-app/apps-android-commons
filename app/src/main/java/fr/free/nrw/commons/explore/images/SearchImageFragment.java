...
public class SearchImageFragment extends CommonsDaggerSupportFragment {
  ...
  private final SearchImagesAdapterFactory adapterFactory =
      new SearchImagesAdapterFactory(
          item -> {
  ...
  public View onCreateView(
    ...
    imagesRecyclerView.addOnScrollListener(
  ...
  private void handleNoInternet() {
    if (null
        != getView()) { // We have exposed public methods to update our ui, we will have to add null
      // checks until we make this lifecycle aware
      if (null != progressBar) {
        progressBar.setVisibility(GONE);
      }
