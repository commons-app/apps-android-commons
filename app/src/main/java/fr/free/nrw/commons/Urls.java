...
class Urls {
  ...
  static final String CREDITS_URL =
      "https://github.com/commons-app/apps-android-commons/blob/master/CREDITS";
  static final String FAQ_URL =
      "https://github.com/commons-app/apps-android-commons/wiki/Frequently-Asked-Questions";
  static final String PLAY_STORE_URL =
      "https://play.google.com/store/apps/details?id=fr.free.nrw.commons";
  static final String TRANSLATE_WIKI_URL =
      "https://translatewiki.net/w/i.php?title=Special:Translate&group=commons-android-strings&filter=%21translated&action=translate&language=";
