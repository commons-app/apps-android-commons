...
public abstract class CommonsDaggerAppCompatActivity extends AppCompatActivity
   ...
   */
  private void inject() {
    ApplicationlessInjection injection =
        ApplicationlessInjection.getInstance(getApplicationContext());
