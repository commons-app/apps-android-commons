...
public class NearbyFilterSearchRecyclerViewAdapter
  ...
  public NearbyFilterSearchRecyclerViewAdapter(
      Context context, ArrayList<Label> labels, RecyclerView recyclerView) {
    ...
    View itemView =
        inflater.inflate(
            callback.isDarkTheme()
                ? R.layout.nearby_search_list_item_dark
                : R.layout.nearby_search_list_item,
            parent,
            false);
  ...
  public void onBindViewHolder(@NonNull RecyclerViewHolder holder, int position) {
    ...
    holder.placeTypeLayout.setBackgroundColor(
        label.isSelected()
            ? ContextCompat.getColor(context, R.color.divider_grey)
            : callback.isDarkTheme() ? Color.BLACK : Color.WHITE);
