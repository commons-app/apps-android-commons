...
public class GridViewAdapter extends ArrayAdapter {
  ...
  /**
   * Adds more item to the list Its triggered on scrolling down in the list
   *
   * @param images
   */
  ...
  /**
   * Check the first item in the new list with old list and returns true if they are same Its
   * triggered on successful response of the fetch images API.
   *
   * @param images
   */
  ...
  public View getView(int position, View convertView, ViewGroup parent) {
    ...
    if (convertView == null) {
      convertView =
          LayoutInflater.from(getContext()).inflate(R.layout.layout_category_images, null);
    }
