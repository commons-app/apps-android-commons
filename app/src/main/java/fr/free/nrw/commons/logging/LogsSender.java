...
public abstract class LogsSender implements ReportSender {
  ...
  /**
   * * Provides any extra information that you want to send. The return value will be delivered
   * inside the report verbatim
   *
   * @return
   */
  ...
  private Uri getZippedLogFileUri(Context context, CrashReportData report) {
    try {
      ...
      return FileProvider.getUriForFile(
          context, context.getApplicationContext().getPackageName() + ".provider", zipFile);
    } catch (IOException e) {
