...
/**
 * This class helps in creating adapter for imagesRecyclerView in SearchImagesFragment, implementing
 * onClicks on imagesRecyclerView Items
 */
class SearchImagesAdapterFactory {
  ...
  public RVRendererAdapter<Media> create(List<Media> searchImageItemList) {
    RendererBuilder<Media> builder =
        new RendererBuilder<Media>().bind(Media.class, new SearchImagesRenderer(listener));
    ListAdapteeCollection<Media> collection =
