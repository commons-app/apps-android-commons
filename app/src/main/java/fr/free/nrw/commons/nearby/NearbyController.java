...
public class NearbyController {
  ...
  public static LatLng
      latestSearchLocation; // Can be current and camera target on search this area button is used
  public static double latestSearchRadius =
      10.0; // Any last search radius except closest result search
   ...
   * @return NearbyPlacesInfo a variable holds Place list without distance information and boundary
   *     coordinates of current Place List
   */
  public NearbyPlacesInfo loadAttractionsFromLocation(
      LatLng curLatLng,
      LatLng searchLatLng,
      boolean returnClosestResult,
    ...
    if (null != places && places.size() > 0) {
      ...
      // Returning closes result means we use the controller for nearby card. So no need to set
      // search this area flags
      if (!returnClosestResult) {
        ...
        // Our radius searched around us, will be used to understand when user search their own
        // location, we will follow them
  ...
  public static List<Place> loadAttractionsFromLocationToPlaces(
      LatLng curLatLng, List<Place> placeList) {
  ...
  public static List<NearbyBaseMarker> loadAttractionsFromLocationToBaseMarkerOptions(
      LatLng curLatLng, List<Place> placeList, Context context, List<Place> bookmarkplacelist) {
