...
public class ContributionsSyncAdapter extends AbstractThreadedSyncAdapter {
  ...
  private boolean fileExists(ContentProviderClient client, String filename) {
    ...
    try (Cursor cursor =
        client.query(BASE_URI, existsQuery, existsSelection, new String[] {filename}, "")) {
  ...
  public void onPerformSync(
    ...
    ApplicationlessInjection.getInstance(getContext().getApplicationContext())
        ...
        .inject(this);
    // This code is(was?) fraught with possibilities of race conditions, but lalalalala I can't hear
    // you!
    ...
    userClient
        ...
        .buffer(10)
        .subscribe(
            imageValues -> contentProviderClient.bulkInsert(BASE_URI, imageValues.toArray(EMPTY)));
