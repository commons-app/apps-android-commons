...
public class LatLng implements Parcelable {
  ...
  /**
   * Accepts latitude and longitude. North and South values are cut off at 90°
   *
   * @param latitude the latitude
   * @param longitude the longitude
   * @param accuracy the accuracy
   *     <p>Examples: the Statue of Liberty is located at 40.69° N, 74.04° W The Statue of Liberty
   *     could be constructed as LatLng(40.69, -74.04, 1.0) where positive signifies north, east and
   *     negative signifies south, west.
   */
  ...
  public String getPrettyCoordinateString() {
    return formatCoordinate(this.latitude)
        + " "
        + this.getNorthSouth()
        + ", "
        + formatCoordinate(this.longitude)
        + " "
        + this.getEastWest();
  }
