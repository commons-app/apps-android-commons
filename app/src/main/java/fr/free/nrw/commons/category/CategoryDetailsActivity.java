...
/**
 * This activity displays details of a particular category Its generic and simply takes the name of
 * category name in its start intent to load all images, subcategories in a particular category on
 * wikimedia commons.
 */
...
public class CategoryDetailsActivity extends NavigationBaseActivity
  ...
  /**
   * This method is called on success of API call for Images inside a category. The viewpager will
   * notified that number of items have changed.
   */
  @Override
   ...
   * query and adds it to the grid view and viewpager adapter
   */
  @Override
