...
public class PermissionUtils {
   ...
   *
   * <p>rationaleTitle and rationaleMessage can be invalid @StringRes. If the value is -1 then no
   * permission rationale will be displayed and permission would be requested
   *
   * <p>Sample usage:
   *
   * <p>PermissionUtils.checkPermissionsAndPerformAction(activity,
   ...
   *
   * <p>If you don't want the permission rationale to be shown then use:
   *
   * <p>PermissionUtils.checkPermissionsAndPerformAction(activity,
   ...
   * @param rationaleTitle rationale title to be displayed when permission was denied. It can be an
   *     invalid @StringRes
   * @param rationaleMessage rationale message to be displayed when permission was denied. It can be
   *     an invalid @StringRes
   */
  public static void checkPermissionsAndPerformAction(
    ...
    checkPermissionsAndPerformAction(
        activity, permission, onPermissionGranted, null, rationaleTitle, rationaleMessage);
  }
   ...
   * <p>PermissionUtils.checkPermissionsAndPerformAction(activity,
   * Manifest.permission.WRITE_EXTERNAL_STORAGE, () -> initiateCameraUpload(activity), () ->
   * showMessage(), R.string.storage_permission_title, R.string.write_storage_permission_rationale);
   *
   * @param activity activity requesting permissions
   * @param permission the permission being requests
   * @param onPermissionGranted the runnable to be executed when the permission is granted
