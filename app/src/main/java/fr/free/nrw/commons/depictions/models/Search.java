...
/**
 * Model class for object obtained while parsing depiction response this class contains all the
 * details of for the media object
 */
...
public class Search {
   ...
   * @param pageid
   */
  public Search(Integer ns, String title, Integer pageid, Integer size, Integer wordcount,
      String snippet, String timestamp) {
    super();
    this.ns = ns;
    this.title = title;
    this.pageid = pageid;
