...
public class Utils {
  ...
  public static String fixExtension(String title, String extension) {
    ...
    // If extension is still null, make it jpg. (Hotfix for
    // https://github.com/commons-app/apps-android-commons/issues/228)
  ...
  public static void rateApp(Context context) {
    ...
    try {
      ...
      handleWebUrl(
          context, Uri.parse("https://play.google.com/store/apps/details?id=" + appPackageName));
    }
  }
  ...
  public static void handleWebUrl(Context context, Uri url) {
    ...
    if (browserIntent.resolveActivity(context.getPackageManager()) == null) {
      Toast toast =
          Toast.makeText(context, context.getString(R.string.no_web_browser), LENGTH_SHORT);
      toast.show();
      return;
    }
  ...
  /**
   * Util function to handle geo coordinates It no longer depends on google maps and any app capable
   * of handling the map intent can handle it
   *
   * @param context
   * @param latLng
   */
