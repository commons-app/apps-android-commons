...
public class NearbyParentFragment extends CommonsDaggerSupportFragment
    ...
    private fr.free.nrw.commons.location.models.LatLng lastKnownLocation;
    private boolean isVisibleToUser;
    private MapboxMap.OnCameraMoveListener cameraMoveListener;
    private fr.free.nrw.commons.location.models.LatLng lastFocusLocation;
    ...
    private void locationPermissionGranted() {
        ...
        fr.free.nrw.commons.location.models.LatLng target=lastFocusLocation;
    ...
    private void startMapWithCondition(final String condition) {
        ...
        if (applicationKvStore.getString("LastLocation")!=null) {
            ...
            lastKnownLocation
                = new fr.free.nrw.commons.location.models.LatLng(Double.parseDouble(locationLatLng[0]),
            ...
            lastKnownLocation = new fr.free.nrw.commons.location.models.LatLng(51.50550,
                -0.07520,1f);
            position = new CameraPosition.Builder()
                .target(LocationUtils.commonsLatLngToMapBoxLatLng(lastKnownLocation))
                .zoom(ZOOM_OUT)
        ...
        if (null != lastPlaceToCenter) {
            ...
            final CameraPosition position = new CameraPosition.Builder()
                    .target(LocationUtils.commonsLatLngToMapBoxLatLng(
                            new fr.free.nrw.commons.location.models.LatLng(lastPlaceToCenter.location.getLatitude() - cameraShift,
    ...
    @Override
    public fr.free.nrw.commons.location.models.LatLng getLastLocation() {
    ...
    @Override
    public void centerMapToPosition(fr.free.nrw.commons.location.models.LatLng searchLatLng) {
    ...
    @Override
    public void populatePlaces(final fr.free.nrw.commons.location.models.LatLng curlatLng) {
    ...
    private void populatePlacesForCurrentLocation(
        final fr.free.nrw.commons.location.models.LatLng curlatLng,
        final fr.free.nrw.commons.location.models.LatLng searchLatLng, @Nullable final String customQuery){
    ...
    private void handleLocationUpdate(final fr.free.nrw.commons.location.models.LatLng latLng, final LocationServiceManager.LocationChangeType locationChangeType){
    ...
    @Override
    public void onLocationChangedSignificantly(final fr.free.nrw.commons.location.models.LatLng latLng) {
    ...
    @Override
    public void onLocationChangedSlightly(final fr.free.nrw.commons.location.models.LatLng latLng) {
    ...
    @Override
    public void onLocationChangedMedium(final fr.free.nrw.commons.location.models.LatLng latLng) {
     ...
     */
    @Override
    public void addCurrentLocationMarker(final fr.free.nrw.commons.location.models.LatLng curLatLng) {
     ...
     */
    @Override
    public void updateMapToTrackPosition(final fr.free.nrw.commons.location.models.LatLng curLatLng) {
    ...
    @Override
    public fr.free.nrw.commons.location.models.LatLng getCameraTarget() {
     ...
     * @param curLatLng current location
     */
    public void updateMarker(final boolean isBookmarked, final Place place, @Nullable final fr.free.nrw.commons.location.models.LatLng curLatLng) {
    ...
    @Override
    public void recenterMap(fr.free.nrw.commons.location.models.LatLng curLatLng) {
