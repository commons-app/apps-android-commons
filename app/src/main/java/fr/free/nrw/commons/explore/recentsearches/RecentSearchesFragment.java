...
public class RecentSearchesFragment extends CommonsDaggerSupportFragment {
  ...
  public View onCreateView(
          ...
          new AlertDialog.Builder(getContext())
              ...
              .setPositiveButton(
                  ...
                  (dialog, which) -> {
                    ...
                    Toast.makeText(
                            getContext(),
                            getString(R.string.search_history_deleted),
                            Toast.LENGTH_SHORT)
                        .show();
                    recentSearches = recentSearchesDao.recentSearches(10);
                    adapter =
                        new ArrayAdapter<>(
                            getContext(), R.layout.item_recent_searches, recentSearches);
    ...
    recentSearchesList.setAdapter(adapter);
    recentSearchesList.setOnItemClickListener(
        (parent, view, position, id) ->
            ((SearchActivity) getContext()).updateText(recentSearches.get(position)));
    recentSearchesList.setOnItemLongClickListener(
        (parent, view, position, id) -> {
          new AlertDialog.Builder(getContext())
