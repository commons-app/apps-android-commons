...
public class UploadActivity extends BaseActivity
    implements UploadContract.View, UploadBaseFragment.Callback {
  ...
  private void initViewPager() {
    ...
    vpUpload.addOnPageChangeListener(
  ...
  public void updateTopCardTitle() {
    tvTopCardTitle.setText(
        getResources()
            .getQuantityString(
                R.plurals.upload_count_title, uploadableFiles.size(), uploadableFiles.size()));
  }
  ...
  private void receiveSharedItems() {
    ...
    if (uploadableFiles == null || uploadableFiles.isEmpty()) {
      ...
      for (UploadableFile uploadableFile : uploadableFiles) {
        ...
        uploadMediaDetailFragment.setCallback(
            new UploadMediaDetailFragmentCallback() {
              @Override
  ...
  private void receiveInternalSharedItems() {
    ...
    Timber.d(
        "Received intent %s with action %s and from source %s",
        intent.toString(), intent.getAction(), source);
  ...
  private void showInfoAlert(
      int titleStringID, int messageStringId, Runnable positive, String... formatArgs) {
