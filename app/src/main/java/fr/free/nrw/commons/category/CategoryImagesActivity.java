...
/**
 * This activity displays pictures of a particular category Its generic and simply takes the name of
 * category name in its start intent to load all images in a particular category. This activity is
 * currently being used to display a list of featured images, which is nothing but another category
 * on wikimedia commons.
 */
public class CategoryImagesActivity extends NavigationBaseActivity
  ...
  /**
   * This method is called on backPressed of anyFragment in the activity. We are changing the icon
   * here from back to hamburger icon.
   */
  @Override
  ...
  /**
   * Gets the categoryName from the intent and initializes the fragment for showing images of that
   * category
   */
  ...
  public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
    if (mediaDetails == null || !mediaDetails.isVisible()) {
      ...
      // coming back to the search activity. See
      // https://github.com/commons-app/apps-android-commons/issues/1631
   ...
   *
   * @param i It is the index of which media object is to be returned which is same as current index
   *     of viewPager.
   * @return Media Object
   */
  @Override
  ...
  /**
   * This method is called when viewPager has reached its end. Fetches more images using search
   * query and adds it to the gridView and viewpager adapter
   */
