...
public class AchievementsActivity extends NavigationBaseActivity {
  ...
  private void setWikidataEditCount() {
    ...
    compositeDisposable.add(
        okHttpJsonApiClient
            ...
            .observeOn(AndroidSchedulers.mainThread())
            .subscribe(
                edits -> wikidataEditsText.setText(String.valueOf(edits)),
                e -> {
                  Timber.e("Error:" + e);
                }));
  }
  ...
  private void showSnackBarWithRetry() {
    ...
    ViewUtil.showDismissibleSnackBar(
  ...
  private void setUploadProgress(int uploadCount) {
    if (uploadCount == 0) {
      ...
      imagesUploadedProgressbar.setProgress(100 * uploadCount / levelInfo.getMaxUploadCount());
    ...
    if (progressBar != null) {
      levelInfo =
          LevelController.LevelInfo.from(
              achievements.getImagesUploaded(),
  ...
  public void showAlert(Bitmap screenshot) {
    ...
    alertadd.setPositiveButton(
        R.string.about_translate_proceed, (dialog, which) -> shareScreen(screenshot));
