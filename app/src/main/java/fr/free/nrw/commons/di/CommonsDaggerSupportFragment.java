...
public abstract class CommonsDaggerSupportFragment extends Fragment implements
  ...
  public void inject() {
    ...
    AndroidInjector<Fragment> fragmentInjector = hasSupportFragmentInjector
        .supportFragmentInjector();

    if (fragmentInjector == null) {
      throw new NullPointerException(String.format("%s.supportFragmentInjector() returned null",
