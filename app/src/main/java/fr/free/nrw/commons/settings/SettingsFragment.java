...
public class SettingsFragment extends PreferenceFragmentCompat {
  ...
  public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
    ...
    if (multiSelectListPref != null) {
      multiSelectListPref.setOnPreferenceChangeListener((preference, newValue) -> {
        if (newValue instanceof HashSet && !((HashSet) newValue)
            .contains(getString(R.string.exif_tag_location))) {
   ...
   * Adds preference changed listener and saves value chosen by user to shared preferences to
   * remember later
   */
