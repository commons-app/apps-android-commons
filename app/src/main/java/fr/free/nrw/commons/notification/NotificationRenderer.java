...
public class NotificationRenderer extends Renderer<Notification> {
  ...
  /**
   * Cleans up the notification text and sets it as the title Clean up is required to fix escaped
   * HTML string and extra white spaces at the beginning of the notification
   *
