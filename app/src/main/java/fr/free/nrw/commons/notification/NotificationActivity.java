...
public class NotificationActivity extends NavigationBaseActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    mNotificationWorkerFragment =
        (NotificationWorkerFragment)
            getFragmentManager().findFragmentByTag(TAG_NOTIFICATION_WORKER_FRAGMENT);
    initListView();
    initDrawer();
    setPageTitle();
  }
  ...
  public void removeNotification(Notification notification) {
    Disposable disposable =
        Observable.defer(
                (Callable<ObservableSource<Boolean>>) () -> controller.markAsRead(notification))
  ...
  private void setAdapter(List<Notification> notificationList) {
    ...
    notificationAdapterFactory =
        new NotificationAdapterFactory(
            new NotificationRenderer.NotificationClicked() {
              @Override
