...
public class NearbyNotificationCardView extends SwipableCardView {
  ...
  public NearbyNotificationCardView(
  ...
  protected void onAttachedToWindow() {
    ...
    // If you don't setVisibility after getting layout params, then you will se an empty space in
    // place of nearby NotificationCardView
    if (((MainActivity) getContext()).defaultKvStore.getBoolean("displayNearbyCardView", true)
        && this.cardViewVisibilityState
  ...
  private void setActionListeners(Place place) {
    this.setOnClickListener(
        view -> {
          ...
          ((NearbyParentFragment) m.contributionsActivityPagerAdapter.getItem(NEARBY_TAB_POSITION))
  ...
  public boolean onSwipe(View view) {
    ...
    ViewUtil.showLongToast(
        getContext(), getResources().getString(R.string.nearby_notification_dismiss_message));
    return true;
  }
