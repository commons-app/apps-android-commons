...
public class FileLoggingTree extends Timber.DebugTree implements LogLevelSettableTree {
  ...
  public FileLoggingTree(
      int logLevel, String logFileName, String logDirectory, int fileSizeInKb, Executor executor) {
  ...
  @Override
  protected void log(
      final int priority, final String tag, @NonNull final String message, Throwable t) {
