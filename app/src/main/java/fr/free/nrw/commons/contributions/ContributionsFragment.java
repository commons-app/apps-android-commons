...
public class ContributionsFragment
  ...
  public void updateLimitedConnectionToggle(Menu menu) {
    ...
    checkable.setIcon(
        (isEnabled) ? R.drawable.ic_baseline_cloud_off_24 : R.drawable.ic_baseline_cloud_queue_24);
  ...
  public void retryUpload(Contribution contribution) {
    if (NetworkUtils.isInternetConnectionEstablished(getContext())) {
      if (contribution.getState() == STATE_FAILED || contribution.getState() == STATE_PAUSED
