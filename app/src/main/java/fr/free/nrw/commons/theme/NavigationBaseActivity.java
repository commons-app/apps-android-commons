...
public abstract class NavigationBaseActivity extends BaseActivity
  ...
  /**
   * This method changes the toolbar icon to back regardless of any conditions that there is any
   * fragment in the backStack or not
   */
    ...
    switch (itemId) {
      ...
      case R.id.action_feedback:
        ...
        feedbackIntent.putExtra(
            Intent.EXTRA_EMAIL, new String[] {CommonsApplication.FEEDBACK_EMAIL});
        ...
        logoutClient
            ...
            .subscribe(
                ...
                t -> {
                  progressDialog.cancel();
                  Toast.makeText(
                          NavigationBaseActivity.this, t.getLocalizedMessage(), Toast.LENGTH_SHORT)
                      .show();
                  Timber.e(
                      t, "Something went wrong with post logout api: %s", t.getLocalizedMessage());
                }));
  }
  ...
  private class BaseLogoutListener implements CommonsApplication.LogoutListener {
    ...
    public void onLogoutComplete() {
      ...
      Intent nearbyIntent = new Intent(NavigationBaseActivity.this, LoginActivity.class);
  ...
  */
  ...
  public void finish() {
    ...
    if (Build.VERSION.SDK_INT == 19
        ...
        || Build.VERSION.SDK_INT == 25 && !isTaskRoot() && isRestoredToTop) {
