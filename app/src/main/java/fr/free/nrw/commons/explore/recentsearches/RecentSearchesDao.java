...
public class RecentSearchesDao {
  ...
  public void save(RecentSearch recentSearch) {
    ...
    try {
      if (recentSearch.getContentUri() == null) {
        recentSearch.setContentUri(
            db.insert(RecentSearchesContentProvider.BASE_URI, toContentValues(recentSearch)));
      } else {
  ...
  /**
   * This method is called on confirmation of delete recent searches. It deletes all recent searches
   * from the database
   */
  ...
  public static class Table {
    ...
    public static final String[] ALL_FIELDS = {
      COLUMN_ID, COLUMN_NAME, COLUMN_LAST_USED,
    };
