...
public class StringSortingUtils {
  ...
  /**
   * Returns Comparator for sorting strings by their similarity to the filter. By using this
   * Comparator we get results from the highest to the lowest similarity with the filter.
   *
  ...
  /**
   * Levershtein distance algorithm https://en.wikibooks.org/wiki/Algorithm_Implementation/Strings/Levenshtein_distance#Java
   *
   * @param str1 String 1
   * @param str2 String 2
