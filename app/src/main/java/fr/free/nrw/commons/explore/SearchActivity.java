                    ...
                    this.query = query.toString();
                            ...
                            if (!TextUtils.isEmpty(query)) {
                                ...
                                if (FragmentUtils.isFragmentUIActive(searchImageFragment)) {
                                    ...
                                    //Call updateImageList only when data fetching is not started
                                    if(!searchImageFragment.checkProgressBar()) {
                                        searchImageFragment.setRecentQuery(null);
                                        searchImageFragment.updateImageList(query.toString());
                                    }
                                    else
                                        searchImageFragment.setRecentQuery(query.toString());
                                }
