...
public class NearbyPlaces {
  ...
  List<Place> radiusExpander(LatLng curLatLng, String lang, boolean returnClosestResult)
    ...
    if (returnClosestResult) {
      ...
      radius = INITIAL_RADIUS; // refresh radius again, otherwise increased radius is grater than
      // MAX_RADIUS, thus returns null
    } else {
      minResults = 40;
   ...
   * @throws IOException if query fails
   */
  public List<Place> getFromWikidataQuery(LatLng cur, String lang, double radius)
      throws IOException {
