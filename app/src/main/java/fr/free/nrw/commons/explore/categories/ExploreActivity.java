...
public class ExploreActivity extends NavigationBaseActivity
  ...
  private static final String FEATURED_IMAGES_CATEGORY =
  ...
  public Media getMediaAtPosition(int i) {
    ...
    } else if (featuredImagesListFragment.getAdapter() != null
  ...
  /**
   * This method is called when viewPager has reached its end. Fetches more images and adds them to
   * the recycler view and viewpager adapter
   */
  ...
  public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
    ...
    if (mediaDetails == null || !mediaDetails.isVisible()) {
      ...
      // coming back to the explore activity. See
