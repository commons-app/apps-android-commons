    ...
    return Observable.fromCallable(() -> {
      ...
      for (Binding binding : bindings) {
        if (binding.getSubclassLabel().getXmlLang() != null) {
          ...
          String description = "";
          if (binding.getSubclassDescription() != null
              && binding.getSubclassDescription().getXmlLang() != null) {
            description = binding.getSubclassDescription().getValue();
          }
...
//                if (parentClassDescription.get("value") != null) {
