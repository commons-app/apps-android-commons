...
public class ImageUtilsWrapper {
  ...
  public Single<Integer> checkImageGeolocationIsDifferent(
      String geolocationOfFileString, LatLng latLng) {
    boolean isImageGeoLocationDifferent =
    ...
    return Single.just(isImageGeoLocationDifferent)
        ...
        .map(
            isDifferent ->
                isDifferent ? ImageUtils.IMAGE_GEOLOCATION_DIFFERENT : ImageUtils.IMAGE_OK);
  }
}
