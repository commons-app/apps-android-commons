...
public class NearbyParentFragmentPresenter
  ...
  private static final NearbyParentFragmentContract.View DUMMY = (NearbyParentFragmentContract.View) Proxy
      .newProxyInstance(
  ...
  public void updateMapAndList(LocationServiceManager.LocationChangeType locationChangeType) {
    ...
    if (locationChangeType.equals(LOCATION_SIGNIFICANTLY_CHANGED)
      ...
      if (nearbyParentFragmentView
          .isCurrentLocationMarkerVisible()) { // Means user wants to see their live location
        nearbyParentFragmentView.recenterMap(curLatLng);
      }
    }
  }
  ...
  @Override
  public void filterByMarkerType(List<Label> selectedLabels, int state, boolean filterForPlaceState,
  ...
  public void updateMapMarkersToController(List<NearbyBaseMarker> nearbyBaseMarkers) {
    ...
    for (int i = 0; i < nearbyBaseMarkers.size(); i++) {
      ...
      NearbyController.markerExistsMap.put((nearbyBaseMarkers.get(i).getPlace().hasWikidataLink()),
          nearbyBaseMarkers.get(i).getMarker());
      NearbyController.markerNeedPicMap
          .put(((nearbyBaseMarkers.get(i).getPlace().pic == null) ? true : false),
              nearbyBaseMarkers.get(i).getMarker());
    }
  }
  ...
  public boolean searchCloseToCurrentLocation() {
    ...
    double distance = LocationUtils
        .commonsLatLngToMapBoxLatLng(nearbyParentFragmentView.getCameraTarget())
