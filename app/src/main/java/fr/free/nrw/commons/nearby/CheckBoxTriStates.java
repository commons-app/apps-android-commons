...
public class CheckBoxTriStates extends AppCompatCheckBox {
  ...
  /**
   * This flag is needed to avoid accidentally changing the current {@link #state} when {@link
   * #onRestoreInstanceState(Parcelable)} calls {@link #setChecked(boolean)} evoking our {@link
   * #privateListener} and therefore changing the real state.
   */
